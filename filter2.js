                            ...
                            return ( 
                                <li key = { list.category } > {console.log("458filter(1)")}
                                    ...
                                    <button className="cl" ><div className="aligncat">{list.category}</div></button>  </NavLink>*/}
                                        {/*<a href= {path}> */}
                                        <NavLink to={"/category/none"}>First</NavLink>
{/*                                        <NavLink to ={pa} className="lk">{console.log("458filter(3)")} <button className="cl">{console.log("458filter(4)")}{list.category}</button> </NavLink>
{/*                                        {console.log("pa")}
...
{/*
                            ...
                            "NONE" 
                                ...
                                */
                               /*{/* <span className="square border border-primary">SECOND</span>
                        <span className="square border border-primary border-5">FIRST</span>
                        <li><div>                                
                            <NavLink to="/" 
                                className={({ isActive }) => 
                        ...
                        <li><div>
                            <NavLink to="/" style={{color: 'green', textDecoration: 'none'}} 
                                activeStyle={{color: 'red', textDecoration: 'none'}}>Home</NavLink>
                            </div></li>
                        <li><div><NavLink to="/" className="square border border-primary border-3">Link</NavLink></div></li>}
                                                        {/*<div>Visit W3Schools.com!</div>*/}
                                {/* const myArray = ['apple', 'banana', 'orange']; const element = 'grapes';
                                    myArray.push(element); const myList = myArray.map((item) => <p>{item}</p>) */}
                                {/* const myArray = ['apple', 'banana', 'orange']; const element = 'grapes';
                                    myArray.push(element); for(let i in myArray){console.log(i)}
                                                ``~~ onCateChange(e,"none") 
                                                ``~~ onCateChange(e,list.category) */ }
                                {/*isActive ? "green 20px" : "blue 20px" */
                                /*isActive ? "#f0f0f0"   : "blue" */
                                /*isActive ? "200px"     : "250px" */ }
